...
{{--        <meta name="csrf-token" content="{{ csrf_token() }}">--}}
        <meta name="description" content="نظام مساند بلس هو نظام يسهل للطلاب تسجيل المواد">
        <meta name="keywords" content="Musand,MusandPlus,مساند المطور, مساند بلس, مساند">
